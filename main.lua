...
local function GetClosestPlayer()
        ...
        for _, v in next, Players:GetPlayers() do
            if v ~= LocalPlayer then
                if v.Character and v.Character:FindFirstChild(Environment.Settings.LockPart) and v.Character:FindFirstChildOfClass("Humanoid") then
                    ...
                    if Environment.Settings.DistanceCheck then
                        local DistanceFromPlayer = (v.Character[Environment.Settings.LockPart].Position - LocalPlayer.Character.HumanoidRootPart.Position).Magnitude
                        if DistanceFromPlayer > Environment.Settings.MaxDistance then continue end
                    end
    ...
    elseif Environment.Locked and Environment.Locked.Character and Environment.Locked.Character:FindFirstChild(Environment.Settings.LockPart) then
        ...
        if Environment.Settings.DistanceCheck then
            local DistanceFromPlayer = (Environment.Locked.Character[Environment.Settings.LockPart].Position - LocalPlayer.Character.HumanoidRootPart.Position).Magnitude
